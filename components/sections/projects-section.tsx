          ...
          <Suspense fallback={
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <AdvancedProjectCard
                ...
                description="An Instahyre-inspired job portal using React, Node.js, and Appwrite, focusing on AI-driven job recommendations. Features secure authentication, real-time data management, and intelligent matching algorithms."
                image="/instahyre.png"
